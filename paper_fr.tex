...
En particulier, pour le consensus Nakamoto, le nombre de blocs requis pour une transaction augmente exponentiellement avec le nombre de nœuds malveillants, avec une asymptote à $f = n/2$ où le nombre est infini. % wut?
